...
$('#genReport').click( (event) => {
	var dd = {
		content: [
			...
			{
				text: `Invoice No : ${document.getElementById("Tax_Invoice_details_No").value },  Invoice date : ${$("#Tax_Invoice_details_date").val()}, Reverse Charge (Y/N) : ${$("#Tax_Invoice_details_Reverse").val()}, State: Kerala, Code : 32`,
				alignment: 'center'
