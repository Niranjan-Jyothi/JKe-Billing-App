	...
	content: [
		{
			columns:[
				...
				},
				{
					...
					text: ` JKe Company 
							KRWA 82 A
							PPN NAGAR, MAMANGALAM
							GSTIN:32AINPP4465B1ZC`
				}
			]
		},
		{
			...
			columns:[
				{
					...
					text: ` Invoice No : ${$("#Tax_Invoice_details_No").val()}
							Invoice date : ${$("#Tax_Invoice_details_date").val()}
							Reverse Charge (Y/N) : ${$("#Tax_Invoice_details_Reverse").val()}
							State: ${$("#Tax_Invoice_details_State").val()}       Code : ${$("#Tax_Invoice_details_Code").val()}`
				},
				{
		...
		},
		{
			columns :[
				...
				{
					text : `${$("#BillToParty_Name").val()}
							${$("#BillToParty_Address").val()}
							${$("#BillToParty_GSTIN").val()}
							${$("#BillToParty_State").val()}  Code : ${$("#BillToParty_Code").val()}`
				}
			],	
			margin : [50,10]
...
$('#genReport').click( (event) => {
	...
	//console.log(dd.content[5]);  -- this is the table tip where we need to appende table data
		...
		dd.content[5].table.body.push(
			...
			[
				...
				{	
					...
					text : product.TaxAmount
				},
				{	
					fontSize: 8,
					
					text : product.CGSTRate
				},
				{	
					fontSize: 8,
					
					text : product.CGSTAmt
				},
				{	
					fontSize: 8,
					
					text : product.SGSTRate
				},
				{	
					fontSize: 8,
					
					text : product.SGSTAmt
				},
				{	
					fontSize: 8,
	...
	dd.content[5].table.body.push(
		[
			...
			
			{
				...
				bold : true,
				fontSize: 9,
				text : totalSGSTAmt + totalCGSTAmt + totalTaxAmt
			}
		...
		[
			{
				...
				rowSpan : 4,
				alignment : "center",
				text : " User Input -- Final Price in Text"
			},
			{},{},{},{},{},{},
			{
				colSpan : 4,
		...
		[
			...
			{},{},{},
			{
				...
				text : totalTaxAmt + totalCGSTAmt + totalSGSTAmt
			}
		],
		[
			{	
